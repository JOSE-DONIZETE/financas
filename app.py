...
if "df_lancamentos" not in st.session_state:
    dados_iniciais = [
        {"ID": 1, "Data": date(2026, 8, 1), "Tipo": "Receita", "Valor": 000.00, "Categoria": "Outros", "Conta": "Banco do Brasil", "Status": "Realizado", "Descrição": "Salário Mensal"},
        {"ID": 2, "Data": date(2026, 8, 2), "Tipo": "Despesa", "Valor": 000.00, "Categoria": "Mercado", "Conta": "Cartão Alimentação", "Status": "Realizado", "Descrição": "Compras do Mês"},
        {"ID": 3, "Data": date(2026, 8, 3), "Tipo": "Despesa", "Valor": 000.00, "Categoria": "Transporte", "Conta": "Caixa", "Status": "Realizado", "Descrição": "Combustível"},
        {"ID": 4, "Data": date(2026, 8, 5), "Tipo": "Despesa", "Valor": 000.00, "Categoria": "Saúde", "Conta": "Banco do Brasil", "Status": "Realizado", "Descrição": "Consultas / Remédios"},
        {"ID": 5, "Data": date(2026, 8, 12), "Tipo": "Despesa", "Valor": 000.00, "Categoria": "Casa", "Conta": "Banco do Brasil", "Status": "Realizado", "Descrição": "Aluguel"},
        {"ID": 6, "Data": date(2026, 8, 25), "Tipo": "Despesa", "Valor": 000.00, "Categoria": "Mercado", "Conta": "Cartão Alimentação", "Status": "Pendente", "Descrição": "Supermercado Reposição"},
        {"ID": 7, "Data": date(2026, 8, 28), "Tipo": "Receita", "Valor": 000.00, "Categoria": "Outros", "Conta": "Banco do Brasil", "Status": "Pendente", "Descrição": "Projeto Freelance"}
    ]
